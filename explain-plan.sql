...
-- Reads: 해당 단계까지 디스크에서 읽은 블록 수(물리적 IO 횟수, 누적) => VM 이라서 안나오는건지?, 버전이 달라서 안나오는건지?
...
-----------------------------------------------------------------------------------------------------------------
|   0 | SELECT STATEMENT   |       |      1 |        |    128 |00:00:00.01 |      34 |       |       |          |
|*  1 |  HASH JOIN         |       |      1 |    488 |    128 |00:00:00.01 |      34 |   908K|   908K| 1286K (0)|
|*  2 |   TABLE ACCESS FULL| M_CUS |      1 |     60 |     60 |00:00:00.01 |       7 |       |       |          |
|*  3 |   TABLE ACCESS FULL| T_ORD |      1 |    244 |    198 |00:00:00.01 |      24 |       |       |          |
-----------------------------------------------------------------------------------------------------------------
 */
SELECT *
...
-- 최소한의 ID로 SQL 처리 될 수 있도록 적절한 인덱스 전략과 함께 적절한 SQL이 선행 되어야 함